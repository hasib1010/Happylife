      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-xl font-bold mb-4">HappyLife.Services</h2>
            <p className="text-gray-300 mb-4">
              Connecting you with health and wellness providers and products for a balanced life.
            </p>
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/auth/signup?role=provider" className="text-gray-300 hover:text-white">
                  Join as Provider
                </Link>
              </li>
              <li>
                <Link href="/auth/signup?role=seller" className="text-gray-300 hover:text-white">
                  Join as Seller
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <p className="text-gray-300 text-center">
            &copy; {currentYear} HappyLife.Services. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
