...
import { Loader2, Plus, X, Image as ImageIcon, Star, Trash2 } from 'lucide-react';
...
export default function EditProduct() {
    ...
    const [businessHours, setBusinessHours] = useState([
        { day: 0, open: '09:00', close: '17:00', isClosed: false },
        { day: 1, open: '09:00', close: '17:00', isClosed: false },
        { day: 2, open: '09:00', close: '17:00', isClosed: false },
        { day: 3, open: '09:00', close: '17:00', isClosed: false },
        { day: 4, open: '09:00', close: '17:00', isClosed: false },
        { day: 5, open: '09:00', close: '17:00', isClosed: false },
        { day: 6, open: '09:00', close: '17:00', isClosed: true },
    ]);
        ...
        const fetchProduct = async () => {
            try {
                ...
                reset({
                    ...
                    'contact.email': data.product.contact?.email || session?.user?.email || '',
                    'contact.phone': data.product.contact?.phone || '',
                    'contact.website': data.product.contact?.website || '',
                    'location.address': data.product.location?.address || '',
                    'location.city': data.product.location?.city || '',
                    'location.state': data.product.location?.state || '',
                    'location.country': data.product.location?.country || '',
                    'location.zipCode': data.product.location?.zipCode || '',
                    'location.isRemote': data.product.location?.isRemote || false,
                });

                // Set arrays and images
                setImages(data.product.images || []);
                setFeatures(data.product.features?.length > 0 ? data.product.features : ['']);
                setSpecifications(data.product.specifications?.length > 0 ? data.product.specifications : [{ name: '', value: '' }]);
                setFaqs(data.product.faqs?.length > 0 ? data.product.faqs : [{ question: '', answer: '' }]);
                setBusinessHours(data.product.businessHours?.length > 0 ? data.product.businessHours : [
                    { day: 0, open: '09:00', close: '17:00', isClosed: false },
                    { day: 1, open: '09:00', close: '17:00', isClosed: false },
                    { day: 2, open: '09:00', close: '17:00', isClosed: false },
                    { day: 3, open: '09:00', close: '17:00', isClosed: false },
    ...
    }, [params.id, reset, session?.user?.email, router]);
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <TabsContent value="hours">
                            <div className="space-y-6">
                                ...
                                <Alert>
                                    <AlertDescription>
                                        Review all information before submitting. Your product will be updated with the status you selected.
                                    </AlertDescription>
                                </Alert>
